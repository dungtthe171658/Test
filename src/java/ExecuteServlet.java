...
public class ExecuteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (a <= 0 || b <= 0) {
                out.println("<h4>You must input an interger > 0</h4>");
            }
            if (numa == null || numa.isEmpty() || numb == null || numb.isEmpty()) {
                out.println("<h4>You must input an interger not empty </h4>");
            } else {
                out.println("<h4>a = " + a + "and b = " + b + "=> out put :" + timUocChungNhoNhat(a, b) + "</h4>");
            }
